...
public class SavingList extends AppCompatActivity {


    SavingAdayAdapter memberAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(SavingList.this);
        ...
        RetrofitClient.getInstance().getApi().getMember(userphone).enqueue(new Callback<List<MemberHelper>>() {
            ...
            public void onResponse(Call<List<MemberHelper>> call, Response<List<MemberHelper>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    memberAdapter = new SavingAdayAdapter(SavingList.this, listdata);
