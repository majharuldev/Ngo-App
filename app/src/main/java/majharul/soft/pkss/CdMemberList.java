...
import majharul.soft.pkss.adapter.CdAdayAdapter;
...
public class CdMemberList extends AppCompatActivity {
    CdAdayAdapter memberAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cd_member_list);
        ...
        String category = "সিডি সদস্য";


        RetrofitClient.getInstance().getApi().getlist(category).enqueue(new Callback<List<MemberHelper>>() {
            @Override
            public void onResponse(Call<List<MemberHelper>> call, Response<List<MemberHelper>> response) {
                if (response.isSuccessful() && response.body() != null) {

                    listdata = response.body();
                    memberAdapter = new CdAdayAdapter(CdMemberList.this, listdata);
